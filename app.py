...
# 2. KHỞI TẠO DUY NHẤT ST_MATHLIVE TỪ THƯ MỤC BUILD REACT
parent_dir = os.path.dirname(os.path.abspath(__file__))
build_dir = os.path.join(parent_dir, "st_mathlive", "frontend", "build")

# Khai báo component st_mathlive
...
def interactive_math_editor(key: str, text: str, **kwargs) -> str:
    """Wrapper gọi trực tiếp component st_mathlive"""
    try:
        val = st_mathlive_comp(value=text, key=key, default=text)
