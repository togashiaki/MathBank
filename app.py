...
if st.session_state["current_nav_tab"] == "📋":
    ...
    <div class="header-info-bar">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <span style="font-size:0.8rem; color:#78716c; background-color:#f0ebe1; padding:4px 12px; border-radius:999px; font-weight:600;">MÔN TOÁN GDPT 2018</span>
        </div>
...
# TRANG 4: MỤC LỤC & SƠ ĐỒ DẠNG BÀI (THEO DÕI SỐ LƯỢNG CÂU HỎI - ACCORDION THU GỌN)
    ...
    with col_toc_content:
        ...
        for c_idx in sorted_chaps:
            ...
            # Ghép chuỗi HTML không khoảng trắng đầu dòng để tránh lỗi code-block Markdown
            topic_rows = []
