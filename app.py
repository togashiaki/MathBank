...
<style>
    ...
    /* ĐỒNG BỘ PHÔNG CHỮ GOOGLE SANS CHUẨN */
...
<head>
    ...
    <style>
        ...
        /* KHUNG SOẠN THẢO CÓ CHIỀU CAO CỐ ĐỊNH & THANH CUỘN */
        .editor-container { 
        ...
        /* THANH TRƯỢT TỐI GIẢN BO TRÒN GIỐNG ẢNH MẪU */
...
<body>
    ...
    <script>
        ...
        window.addEventListener('load', () => { 
            ...
            sendToStreamlit("streamlit:setFrameHeight", { height: 400 });
        });
    </script>
</body>
</html>"""
